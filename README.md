...
그래서 이걸 그대로 클론 코딩 한다는 거는 CSS 공부밖에 안되는 것으로 확인됬다

피그마로 디자인토큰을 관리하기에는 부적합하다
피그마에서 구현 불가능한 기능 구현을 위한 스타일 코드 작성 기법이 많다

피그마에 의존적인 것이 불가능하다
핵심적인 수치, 가변적인 수치만 관리하고
디자인적인 영역을 넓히는 것이 좋아보임
...
언제든지 다시 개발할 수 있는 잘 정리된 디자인 시스템
